...
<div class="btn-group pull-right">
    ...
    <a href="<?= Yii::$app->urlManager->createUrl('//countrys?CountrySearch[lang]=en'); ?>" class="btn <?php if (isset($_GET['CountrySearch']['lang']) && $_GET['CountrySearch']['lang'] == 'en'): ?> btn-primary <?php else : ?> btn-default <?php endif; ?>">Englsih</a>
</div>
